...
export function useCalendar(initialDate = new Date()) {
  ...
  const calendarDays = useMemo(() => {
    const days = [];
    for (let i = 0; i < firstDayOfMonth; i++) days.push({ day: null, dateStr: null });
  ...
  return { currentMonth, currentYear, monthName, daysInMonth, firstDayOfMonth, calendarDays, goToPreviousMonth, goToNextMonth };
}
