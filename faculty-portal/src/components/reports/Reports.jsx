...
function Reports() {
  ...
  const reportTypes = [
    {
      id: "marks",
      title: "Marks Report",
      description: "Complete marks summary for all students",
      icon: BarChart3,
      color: "blue",
    },
    {
    ...
    },
    {
      ...
      description: "Statistical analysis of grades",
      icon: Award,
      color: "purple",
    },
  ];
  const quickStats = [
    ...
    {
      label: "Total Students Evaluated",
    ...
    <div className="space-y-6">
      ...
      {showingSample && (
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 flex items-center gap-2">
          ...
          <p className="text-sm text-amber-700">
            {" "}
            Reports are generated using sample data. Add your own data to
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <Card.Header>
            {" "}
            <Card.Title icon={FileText}>Generate Reports</Card.Title>{" "}
          </Card.Header>{" "}
          <Card.Content>
            {" "}
            <div className="space-y-4">
              ...
              {reportTypes.map((report) => (
                <button
                  ...
                  className={`w-full flex items-center justify-between p-4 rounded-xl transition-all ${selectedReport === report.id ? "bg-blue-50 border-2 border-blue-300" : "bg-gray-50 hover:bg-gray-100 border-2 border-transparent"}`}
                >
                  {" "}
            ...
            <div className="space-y-4">
              ...
              {quickStats.map((stat) => (
                ...
                >
                  ...
                  <span
                    className={`text-2xl font-bold ${stat.color === "blue" ? "text-blue-600" : stat.color === "green" ? "text-green-600" : "text-purple-600"}`}
                  >
                    {" "}
                    {stat.value}{" "}
                  </span>{" "}
