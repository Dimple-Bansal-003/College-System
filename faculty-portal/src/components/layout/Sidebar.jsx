      ...
      <nav className="flex-1 mt-4">
        ...
        {navItems.map(({ path, label, icon: Icon }) => (
          <NavLink
            ...
            to={path}
            className={({ isActive }) =>
              `w-full flex items-center gap-3 px-6 py-3 text-white text-left transition-colors duration-200 hover:bg-white/10 ${isActive ? "bg-white/15 border-l-4 border-white" : ""}`
            }
          >
            {" "}
            <Icon size={20} /> {label}{" "}
      ...
      <div className="p-4 border-t border-white/10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-blue-200 text-xs">Faculty ID: FAC2024</p>{" "}
          </div>{" "}
        </div>{" "}
      </div>{" "}
    </aside>
