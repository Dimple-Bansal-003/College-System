...
import PaperUploadForm from "./PaperUploadForm.jsx";
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <Card.Header>
          {" "}
          <Card.Title icon={Upload}>Upload Question Paper</Card.Title>{" "}
        </Card.Header>{" "}
        <Card.Content>
          {" "}
          <PaperUploadForm />{" "}
      ...
      <Card>
        ...
        <Card.Header>
          {" "}
          <Card.Title>Uploaded Question Papers</Card.Title>{" "}
        </Card.Header>{" "}
        <Card.Content>
          {" "}
          {showingSample && (
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-4 flex items-center gap-2">
              ...
              <p className="text-sm text-amber-700">
                {" "}
                Showing sample data. Upload your own papers using the form above
                to replace these.{" "}
              </p>{" "}
            </div>
          )}{" "}
